...
tags: [usb-midi-host, tinyusb, usb-midi-device, midi-processing, rp2040, c-sdk, arduino]     # TAG names should always be lowercase
comments: false
pin: false
image:
  path: assets/img/pico-usb-midi-processor/PUMP_dev_board.jpg
  alt: soldered Pico board hardware
---
